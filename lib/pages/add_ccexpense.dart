...
class AddCCExpense extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _AddCCExpenseState();
  }
}

class _AddCCExpenseState extends State<AddCCExpense> {
  ...
  _buildCreditCardNameField() {
    return Card(
      ...
      child: TextFormField(
        validator: (String value) {
          if (value.length <= 0) {
            return "Please enter a Credit Card for your expense";
          }
        },
        onSaved: (String value) => _formData["creditCardName"] = value,
        decoration: InputDecoration(
          contentPadding: EdgeInsets.symmetric(
            horizontal: 20.0,
            vertical: 20.0,
  ...
  _buildSaveButton(Function addCCExpense) {
    return Container(
      ...
      child: MaterialButton(
        onPressed: () {
          ...
          addCCExpense(
            ...
            creditCardName: _formData['creditCardName'],
            bankName: category,
            context: context,
          );
          ...
          child: Column(
            children: <Widget>[
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
                  _buildSaveButton(model.addCCExpense),
                  SizedBox(
                    width: 10,
                  ),
                  _buildCancelButton(),
